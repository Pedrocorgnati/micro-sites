...
describe('buildWhatsAppUrl', () => {
  ...
  it('aceita numero valido 13 digitos (55 + DDD + 9 digitos)', () => {
    const url = buildWhatsAppUrl('5517981539795', 'ola');
    expect(url).toBe('https://wa.me/5517981539795?text=ola');
  });
  ...
  it('normaliza caracteres nao-numericos (parenteses, espacos)', () => {
    const url = buildWhatsAppUrl('+55 (17) 98153-9795', 'ola');
    expect(url).toContain('wa.me/5517981539795');
  });

  it('acrescenta originTag quando slug e fornecido', () => {
    const url = buildWhatsAppUrl('5517981539795', 'ola', 'a01');
